        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link href="/about" className="text-gray-300 hover:text-white">About GreenCart</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link href="/shipping" className="text-gray-300 hover:text-white">Shipping & Delivery</Link></li>
